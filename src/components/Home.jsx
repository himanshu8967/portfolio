...
import logo from "../assets/logo.jpg"; // Go up one directory and then into assets
import TextChange from "./TextChange";


const Home = () => {
  return (
    <div id="Home" className="text-white flex flex-col md:flex-row w-full min-h-screen pt-28 p-10 md:pt-36 md:p-20">
